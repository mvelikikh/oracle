...
--
-- Usage:       @lo {<sid>|sid=<sid>|qcsid=<qcsid>}
--              @lo 123      - shows longops for session 123
--              @lo sid=123  - same
--              @lo qcsid=15 - shows longops for qcsid 15
--
-- Versions:
--              Vers:   1.0.1.1
--                Auth: Velikikh M.
