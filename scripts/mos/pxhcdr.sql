...
REM
REM $Header: 1460440.1 pxhcdr.sql 11.4.5.8 2013/05/10 carlos.sierra $
REM
...
DEF doc_ver = '11.4.5.8';
DEF doc_date = '2013/05/10';
...
SELECT CHR(10)||'<tr>'||CHR(10)||
       ...
       '<td>Consider reducing this value to at most cpu_count * 4 * parallel_threads_per_cpu.<br>'||CHR(10)||
 ...
 WHERE pms.inst_id = cpc.inst_id
   ...
   AND pms.value > cpc.value * 4 * tpc.value;
